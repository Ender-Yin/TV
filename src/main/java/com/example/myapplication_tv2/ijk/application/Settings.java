...
package com.example.myapplication_tv2.ijk.application;
...
public class Settings {
    ...
    public int getPlayer() {
        String key = mAppContext.getString(R.string.pref_key_player);       // key值名字 保存在String资源中
        String value = mSharedPreferences.getString(key, "");       // 根据key值 在本地用户偏好设置 中查找当前偏好播放器
        try {
