...
public class SurfaceRenderView extends SurfaceView implements IRenderView {
    ...
    private void initView(Context context) {
        ...
        getHolder().addCallback(mSurfaceCallback);      // 继承自SurfaceView 所以可以设置SurfaceHolder
    ...
    @Override
    public void addRenderCallback(IRenderCallback callback) {   //  2
    ...
    private SurfaceCallback mSurfaceCallback;   //  1 我们添加到系统SurfaceHolder的东西
    ...
    private static final class SurfaceCallback implements SurfaceHolder.Callback {
        ...
        public void addRenderCallback(@NonNull IRenderCallback callback) {
            ...
            if (mSurfaceHolder != null) {
                ...
                callback.onSurfaceCreated(surfaceHolder, mWidth, mHeight);      //实际调用该callback实例接口的 函数 ， 传入 InternalSurfaceHolder类实例对象 实现了ISurfaceHolder接口的三个函数
            }
        ...
        @Override
        public void surfaceCreated(SurfaceHolder holder) {      // 系统SurfaceHolder.Callback接口的方法
            ...
            for (IRenderCallback renderCallback : mRenderCallbackMap.keySet()) {
                renderCallback.onSurfaceCreated(surfaceHolder, 0, 0);       // 系统接口函数方法 调用 自定义接口的方法     套娃就完事了
            }
        }
