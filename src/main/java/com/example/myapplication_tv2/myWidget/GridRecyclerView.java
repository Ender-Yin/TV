...
//com.example.myapplication_tv2.myWidget.GridRecyclerView
/**
...
public class GridRecyclerView extends RecyclerView {
                ...
                switch (event.getKeyCode()) {
                    ...
                    case KeyEvent.KEYCODE_DPAD_UP:
                        ...
                        if (upView != null) {
                            ...
                            //super.focusSearch(focusView, View.FOCUS_UP).requestFocus();
    ...
    private MainMenuRecyclerView.FocusLostListener mFocusLostListener;
    //焦点移入recyclerview的事件监听
    private MainMenuRecyclerView.FocusGainListener mFocusGainListener;
    /**
     * 设置焦点丢失监听
     */
    public void setFocusLostListener(MainMenuRecyclerView.FocusLostListener focusLostListener) {
     ...
     * 设置焦点获取监听
     */
    public void setGainFocusListener(MainMenuRecyclerView.FocusGainListener focusListener) {
